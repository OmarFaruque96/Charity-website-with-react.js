function About (){
    return(
        <>
            ...
            <div class="site-section bg-image overlay counter" id="about-section">
                <div class="container">
                    <div class="row mb-5">
                    ...
                    <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
                        ...
                        <h1 class="number"><span data-number="15">15</span></h1>
                        <span class="caption text-black">Number of Orphanage</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
                        <div class="block-counter-1">
                        <h1 class="number"><span data-number="392">392</span></h1>
                        <span class="caption text-black">Number of Donations</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
                        <div class="block-counter-1">
                        <h1 class="number"><span data-number="3293">3,293</span></h1>
                        <span class="caption text-black">Number of Volunteers</span>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 col-lg-0 col-lg-3">
                        <div class="block-counter-1">
                        <h1 class="number"><span data-number="1212">1,212</span></h1>
